...
class AdminEventController extends Controller
{
    ...
    {
        //
        $events = DB::table('padu_event')
                    ->select('padu_event.*')
                    ->where('EVENT_TITLE', 'LIKE', '%'.$request->get('event_title').'%')
                    ->orderBy('EVENT_ID', 'DESC')
                    ->paginate(10);
        //
        return view('admin.event_list')->with('events', $events);
    }
    ...
    public function store(Request $request)
    {
        ...
        $primary_key = DB::table('padu_event')
                    ->select('padu_event.EVENT_ID')
                    ->max('EVENT_ID');
    ...
    public function show($id)
    {
        ...
        //
        return view('admin.event_view')->with('events', $events);
    }
    ...
    public function edit($id)
    {
        ...
        //
        return view('admin.event_edit')->with('events', $events);
    }
