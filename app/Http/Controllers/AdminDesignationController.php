...
class AdminDesignationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        //
        return view('admin.designation_list')->with('designations', $designations);
    }
    ...
    {
        //
        return view('admin.designation_create');
    }
    ...
    public function edit($id)
    {
        ...
        //
        return view('admin.designation_edit')->with('designations', $designations);
    }
