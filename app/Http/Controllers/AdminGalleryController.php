...
class AdminGalleryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        //
        return view('admin.gallery_list')->with('images', $images);
    }
    ...
    public function store(Request $request)
    {
        ...
        $primary_key = DB::table('padu_image_gallery')
                    ->select('padu_image_gallery.IMAGE_ID')
                    ->max('IMAGE_ID');
        ...
        if($request->hasFile('gallery_image')){
            ...
            $img = Image::make($request->file('gallery_image')->getRealPath())->fit(400, 250, function ($constraint) { $constraint->upsize(); })->save($thumbnailpath);
        }
        else{
        ...
        $insert = DB::table('padu_image_gallery')
            ->insert([
                'IMAGE_ID' => $image_id,
    ...
    public function show($id)
    {
        ...
        //
        return view('admin.gallery_view')->with('images', $images);
    }
    ...
    public function edit($id)
    {
        ...
        //
        return view('admin.gallery_edit')->with('images', $images);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->hasFile('gallery_image')){
            ...
            $update = DB::table('padu_image_gallery')
                ->where('IMAGE_ID', $id)
                ->update([
                    'IMAGE_TITLE' => $request->get('image_title'),
                    'IMAGE_DESC' => $request->get('content'),
    ...
    public function status(Request $request, $id)
    {
        ...
        $images = DB::table('padu_image_gallery')
                ->select('padu_image_gallery.*')
                ->where('padu_image_gallery.IMAGE_ID', '=', $id)
                ->get();
