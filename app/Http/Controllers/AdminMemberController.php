...
class AdminMemberController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        //
        return view('admin.member_list')->with('members', $members);
    }
    ...
    public function store(Request $request)
    {
        ...
        if($request->hasFile('profile_image')){
            ...
            $img = Image::make($request->file('profile_image')->getRealPath())->fit(200, 200, function ($constraint) { $constraint->upsize(); })->save($thumbnailpath);
        }
        else{
    ...
    public function show($id)
    {
        ...
        //
        return view('admin.member_view')->with('members', $members);
    }
    ...
    public function edit($id)
    {
        ...
        $members = DB::table('users')
                    ...
                    ->get();
        //
        return view('admin.member_edit')->with('members', $members)
                    ->with('aca_designations', $aca_designations)
                    ->with('adm_designations', $adm_designations);
