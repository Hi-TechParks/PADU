...
class AdminAlumniEventController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $events = DB::table('padu_alumni_event')
                    ...
                    ->orderBy('ALUMNI_EVENT_ID', 'DESC')
                    ->paginate(10);
        //
        return view('admin.alumni_event_list')->with('events', $events);
    }
    ...
    {
        //
        return view('admin.alumni_event_create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $primary_key = DB::table('padu_alumni_event')
                    ->select('padu_alumni_event.ALUMNI_EVENT_ID')
                    ->max('ALUMNI_EVENT_ID');
        ...
        if($request->hasFile('event_image')){
            ...
            $img = Image::make($request->file('event_image')->getRealPath())->fit(500, 280, function ($constraint) { $constraint->upsize(); })->save($thumbnailpath);
        }
        else{
        ...
        //
        $insert = DB::table('padu_alumni_event')
                    ->insert([
        ...
        //
        return redirect()->route('alumni_event.create');
    }
    ...
    public function show($id)
    {
        ...
        //
        return view('admin.alumni_event_view')->with('events', $events);
    }
    ...
    public function edit($id)
    {
        ...
        //
        return view('admin.alumni_event_edit')->with('events', $events);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->hasFile('event_image')){
            ...
            //
            $update = DB::table('padu_alumni_event')
                        ->where('ALUMNI_EVENT_ID', $id)
                        ->update([
                            'EVENT_TITLE' => $request->get('event_title'),
                            'EVENT_DESC' => $request->get('content'),
        ...
        //
        return redirect()->route('alumni_event.edit', [$id]);
    }
    ...
    public function status(Request $request, $id)
    {
        ...
        $events = DB::table('padu_alumni_event')
                ->select('padu_alumni_event.*')
                ->where('padu_alumni_event.ALUMNI_EVENT_ID', '=', $id)
                ->get();
