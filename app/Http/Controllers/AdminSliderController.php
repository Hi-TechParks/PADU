...
class AdminSliderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        //
        return view('admin.slider_list')->with('slides', $slides);
    }
    ...
    public function show($id)
    {
        ...
        //
        return view('admin.slider_view')->with('slides', $slides);
    }
    ...
    public function edit($id)
    {
        ...
        //
        return view('admin.slider_edit')->with('slides', $slides);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->hasFile('slide_image')){
            ...
            $update = DB::table('padu_slide_image')
                ->where('SLIDE_IMAGE_ID', $id)
                ->update([
                    'IMAGE_TITLE' => $request->get('slide_title'),
                    'IMAGE_DESC' => $request->get('content'),
    ...
    public function status(Request $request, $id)
    {
        ...
        $slides = DB::table('padu_slide_image')
                ->select('padu_slide_image.*')
                ->where('padu_slide_image.SLIDE_IMAGE_ID', '=', $id)
                ->get();
