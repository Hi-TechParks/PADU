      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 col-xs-12">
            <h1 class="text-center"><span>Alumni Event</span></h1>
          </div>
        </div>
        <div class="row">
              ...
              <div class="event-page-single-box-right">
                <div class="event-page-single-box-header">
                    ...
                    <div class="single-notice-right">
                      <p><a href="/alumni/event/single/{{ $event->ALUMNI_EVENT_ID }}">{{ $event->EVENT_TITLE }}</a></p>
                      <div class="meta-box">
                ...
                <div class="event-page-single-box-footer">
                  ...
                  <a class="read_more" href="/alumni/event/single/{{ $event->ALUMNI_EVENT_ID }}"> Read More</a>
                </div>
              </div>
            </div>
          </div>
