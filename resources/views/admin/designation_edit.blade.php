        ...
        <div class="row">
          ...
          <main class="col-md-9">
            ...
            <div class="card">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <a href="/admin/designation/edit/{{ $designation->DESIGNATION_ID }}" class="btn btn-primary">Refresh</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card">
              <div class="card-body">
                <!--== Data Form Start ==-->
                <form action="/admin/designation/update/{{ $designation->DESIGNATION_ID }}" method="post" enctype="multipart/form-data">
                  @csrf
