                  ...
                  <tr>
                    ...
                    <td>
                      @if( $event->ACTIVE_STATUS == '1' )
                        <a href="/admin/event/status/{{ $event->EVENT_ID }}" class="active_status">Active</a>
                      @else
                        <a href="/admin/event/status/{{ $event->EVENT_ID }}" class="inactive_status">Inactive</a>
                      @endif
                    </td>
                    <td>
                      <a href="/admin/event/show/{{ $event->EVENT_ID }}" class="btn btn-success">View</a>
                      <a href="/admin/event/edit/{{ $event->EVENT_ID }}" class="btn btn-primary">Edit</a>
                    </td>
                  </tr>
                  @endforeach
                </tbody>
