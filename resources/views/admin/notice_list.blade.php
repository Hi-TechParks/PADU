                  ...
                  <tr>
                    ...
                    <td>
                      @if( $notice->ACTIVE_STATUS == '1' )
                        <a href="/admin/notice/status/{{ $notice->NOTICE_ID }}" class="active_status">Active</a>
                      @else
                        <a href="/admin/notice/status/{{ $notice->NOTICE_ID }}" class="inactive_status">Inactive</a>
                      @endif
                    </td>
                    <td>
                      <a href="/admin/notice/show/{{ $notice->NOTICE_ID }}" class="btn btn-success">View</a>
