        ...
        <div class="row">
          ...
          <main class="col-md-9">
            ...
            <div class="card">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <a href="{{ URL('/admin/alumni/notice/create')}}" class="btn btn-primary">Refresh</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card">
              <div class="card-body">
                <!--== Data Form Start ==-->
                <form action="{{url('/admin/alumni/notice/store')}}" method="post" enctype="multipart/form-data">
                  @csrf
