                  ...
                  <tr>
                    ...
                    <td>
                      @if( $designation->ACTIVE_STATUS == '1' )
                        <a href="/admin/designation/status/{{ $designation->DESIGNATION_ID }}" class="active_status">Active</a>
                      @else
                        <a href="/admin/designation/status/{{ $designation->DESIGNATION_ID }}" class="inactive_status">Inactive</a>
                      @endif
                    </td>
                    <td>
                      <a href="/admin/designation/edit/{{ $designation->DESIGNATION_ID }}" class="btn btn-primary">Edit</a>
                    </td>
                  </tr>
                  @endforeach
                </tbody>
