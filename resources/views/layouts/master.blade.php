              ...
              <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown {{ Request::path() == 'academic' ? 'active' : '' }}">
                      <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Academic
                      </a>
                      <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="{{url('/academic')}}">Academic</a>
                        <a class="dropdown-item" href="{{url('/event')}}">Event</a>
                        <a class="dropdown-item" href="{{url('/notice')}}">Notice</a>
                      </div>
                    </li>
                    <li class="nav-item dropdown {{ Request::path() == 'admission' ? 'active' : '' }}">
                      <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Admission
                      </a>
                      <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="{{url('/underGraduation')}}">Under Graduation</a>
                        <a class="dropdown-item" href="{{url('/graduation')}}">Graduation</a>
                        <a class="dropdown-item" href="{{url('/postGraduation')}}">Post-Graduation</a>
                        <a class="dropdown-item" href="{{url('/mPhill')}}">M.Phill</a>
                        <a class="dropdown-item" href="{{url('/phd')}}">PHD</a>
                      </div>
                    </li>
                    <li class="nav-item {{ Request::path() == 'alumni' ? 'active' : '' }}">
                      <a class="nav-link" href="{{url('/alumni')}}">Alumni</a>
                    </li>
                    <li class="nav-item {{ Request::path() == 'publication' ? 'active' : '' }}">
